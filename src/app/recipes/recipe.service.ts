...
export class RecipeService {
    ...
    storeData() {
        ...
        return this.http.put('https://angular2-recipebook.firebaseio.com/recipe.json', body, {headers: headers});
    }

    fetchData() {
        return this.http.get('https://angular2-recipebook.firebaseio.com/recipe.json')
